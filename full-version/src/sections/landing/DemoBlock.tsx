              ...
              <Grid container spacing={1.5}>
                ...
                <Grid item xs={12}>
                  <Box sx={{ position: 'relative', width: `calc(100% + 24px)`, mb: '-30px !important' }}>
                    <Image src={imgdemo2} alt="feature" layout="responsive" width="370px" height="325px" />
                  </Box>
                </Grid>
              </Grid>
            </MainCard>
          ...
          >
            <MainCard contentSX={{ p: 3, background: theme.palette.primary.lighter }}>
              <Grid container spacing={1.5}>
                ...
                <Grid item xs={12}>
                  <Box sx={{ position: 'relative', width: `calc(100% + 24px)`, mb: '-30px !important' }}>
                    <Image src={imgdemo1} alt="feature" layout="responsive" width="370px" height="325px" />
                  </Box>
                </Grid>
              </Grid>
            </MainCard>
          ...
          >
            <MainCard contentSX={{ p: 3 }}>
              <Grid container spacing={1.5}>
                ...
                <Grid item xs={12}>
                  <Box sx={{ position: 'relative', width: `calc(100% + 24px)`, mb: '-30px !important' }}>
                    <Image src={imgdemo3} alt="feature" layout="responsive" width="370px" height="325px" />
                  </Box>
                </Grid>
              </Grid>
            </MainCard>
